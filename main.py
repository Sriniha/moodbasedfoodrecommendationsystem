...
food_data = pd.read_csv('c:/Users/91709/OneDrive/Desktop/mood-based-food-recommender-master/pythonProject2/food_choices.csv')
res_data = pd.read_csv('c:/Users/91709/OneDrive/Desktop/mood-based-food-recommender-master/pythonProject2/zomato.csv', encoding='latin-1')
...
def find_restaurant():
    ...
    restaurants_list = []
    for item in result:
        restaurants = res_data[res_data.Cuisines.str.contains(food_to_cuisine_map[item], case=False)].sort_values(
    ...
    return render_template('result.html', result=result_str, mood=mood, restaurants1=restaurants_list[:3],
                           restaurants2=restaurants_list[3:6], restaurants3=restaurants_list[6:])
